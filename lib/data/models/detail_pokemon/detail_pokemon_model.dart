...
DetailPokemonModel detailPokemonModelFromJson(String str) =>
    DetailPokemonModel.fromJson(json.decode(str));

String detailPokemonModelToJson(DetailPokemonModel data) =>
